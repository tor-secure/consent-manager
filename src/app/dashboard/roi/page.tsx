  ...
  return (
    <div className="px-4 py-6 sm:px-6 lg:px-8">
      <div className="mb-6">
        ...
        <h1 className="mt-1 text-2xl font-semibold tracking-tight">Consent ROI engine</h1>
        <p className="mt-2 max-w-3xl text-sm text-[var(--muted-foreground)]">
          Converts expected consent quality improvements into a relative ROI score per configuration scenario.
        </p>
      </div>
