export function PenaltyCallout({ className = "" }: { className?: string }) {
  return (
    <aside
      className={`rounded-xl border-2 border-[#DC2626] bg-[#FEF2F2] px-4 py-3 text-left ${className}`}
      role="note"
    >
      <p className="text-[13px] font-extrabold uppercase tracking-[0.06em] text-[#B91C1C]">
