...
function ReadOnlyField({ label, value }: { label: string; value: string }) {
  return (
    <div>
      ...
      <div className="field-input flex items-center bg-[var(--muted)]">
        <code className="block min-w-0 overflow-x-auto font-mono text-sm text-[var(--muted-foreground)]">{value}</code>
      </div>
